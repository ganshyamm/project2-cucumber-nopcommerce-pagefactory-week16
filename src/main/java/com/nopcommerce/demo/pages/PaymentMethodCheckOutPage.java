...
public class PaymentMethodCheckOutPage extends UtilityClass {
    private static final Logger log = LogManager.getLogger(PaymentMethodCheckOutPage.class.getName());
