...
public class PaymentCheckOutPage extends UtilityClass {
    private static final Logger log = LogManager.getLogger(PaymentCheckOutPage.class.getName());
    ...
    public void fillCardDetails() {
        ...
        sendTextToElement(cardholderName, "Java Selenium");
        ...
        sendTextToElement(cardCode, "789");
    }
}
